...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2023 at 12:33 AM
...
(11, 'Aleksandar', 'Cvetkovic', 'user', 'slovnipo31@gmail.com', 'pbkdf2:sha256:260000$AcAEgA2iLvdWHae1$d0622ec03a12c1c57c930449a554534f4013e65761eca07798215a610df6d7fc');
...
ALTER TABLE `cart`
  ...
  ADD KEY `cart_ibfk_2` (`id_produkti`);
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`id_korisnik`) REFERENCES `korisnik` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`id_produkti`) REFERENCES `produkti` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
